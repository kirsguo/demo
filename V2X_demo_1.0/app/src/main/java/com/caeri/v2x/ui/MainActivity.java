...
//                mDispatcherHandler.sendMessage(msg1);
                HashMap<String,String> map =new HashMap<String, String>();
                map.put("collisionLevel","2");
                map.put("RVLatitude","29.67281867");
                map.put("RVLongitude","106.4798025");
                HashMap<String,String> map_1 =new HashMap<String, String>();
                map_1.put("collisionLevel","2");
                map_1.put("RVLatitude","29.67291867");
                map_1.put("RVLongitude","106.4798025");
                HashMap<String,String> map_2 =new HashMap<String, String>();
                map_2.put("collisionLevel","2");
                map_2.put("RVLatitude","29.67281867");
                map_2.put("RVLongitude","106.4797025");
                HashMap<String,String> map_3 =new HashMap<String, String>();
                map_3.put("collisionLevel","2");
                map_3.put("RVLatitude","29.67281867");
                map_3.put("RVLongitude","106.4796025");
                ArrayList<HashMap<String,String>> list =new ArrayList<HashMap<String, String>>();
                othersMessage.clear();
                othersMessage.add(map);
                othersMessage.add(map_1);
                othersMessage.add(map_2);
                othersMessage.add(map_3);
//                Log.i(TAG, "onClick: "+othersMessage.toString());
                updateUIMessage(APP_ID_APPIntersectionCollisionWarning);
                Message msg1 = Message.obtain();
                msg1.what = 4;
                msg1.obj = "Good Bye!";
        ...
        sign.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                HashMap<String,String> map = new HashMap<String, String>();
                map.put("speed","20");
                map.put("latitude","29.67271867");
                map.put("longitude","106.4798025");
                ArrayList<HashMap<String,String>> list =new ArrayList<HashMap<String, String>>();
                list.add(map);
                app_last.put(APP_ID_APPMe,list);
                updateUIMessage(APP_ID_APPMe);
                Message msg1 = Message.obtain();
                msg1.what = 3;
                msg1.obj = "Good Bye!";
